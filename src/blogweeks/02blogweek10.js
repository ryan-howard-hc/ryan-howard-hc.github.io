...
const Week10Blog = () => {
    return (
      ...
      <div className="individual-blog">
        ...
        <h2>Biggest struggle in the tech stack?</h2>
        <p>So far, django.. After my foray into SQL, I felt encouraged that backend would be my calling. Delving into the intricate relationships between models, queries, and database tables was a test of patience. Navigating the admin.py and customizing admin views required a deeper understanding of Django's internal mechanics. Django's ecosystem, full of third-party packages and libraries, demands a great deal of research and discernment to know what the hell Im looking at haha. JS was the second most difficult, though I imagine this was due to my freshness to programming. But similarly, I imagine repetition will be my best friend.</p>
        <p>Below is the namesake of django, Django Reinhardt</p>
        <img src="https://media.npr.org/assets/music/news/2010/01/django-c9adb735a15e716afbf59663b7258c055f38b4f4-s1100-c50.jpg"></img>
